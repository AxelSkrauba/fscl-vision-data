...
Wildlife image dataset from Test Region. Prepared for few-shot classification with FSCL-Vision framework.
...
- **Total Species**: 0
- **Source**: iNaturalist
- **Created**: 2025-12-11T09:58:53.209117
...
dataset_path = Path("test_region_dataset")
